$(function () {
  ...
  $('.form-price__slider').ionRangeSlider({
    type: "double",
    prefix: "₽",
    step: 50,
    onStart: function(data) {
      $('.form-price__input--from').text(data.from);
      $('.form-price__input--to').text(data.to);
    },
  ...
  $('.catalog__filters-btn--category').on('click', function () {
    $('.catalog__category-list--category, .catalog__filters-btn--category').toggleClass('dropdown--active');
  });
  ...
  $('.catalog__filters-btn--suggestions').on('click', function () {
    $('.catalog__category-list--suggestions, .catalog__filters-btn--suggestions').toggleClass('dropdown--active');
  });
  ...
  $('.catalog__filters-btn--brand').on('click', function () {
    $('.catalog__category-list--brand, .catalog__filters-btn--brand').toggleClass('dropdown--active');
  });
  ...
  $('.catalog__filters-btn--price').on('click', function () {
    $('.catalog__category-list--price, .catalog__filters-btn--price').toggleClass('dropdown--active');
  });
  ...
  let filterDropdown = $('.catalog__filters-btn--choice');
  let dropdownMenu = $('.catalog__filters-btn--choice, .catalog__category-list--choice');
  ...
  $(document).mouseup(function (e) {
    if ( ! filterDropdown.is(e.target) && filterDropdown.has(e.target).length === 0 &&
        ! dropdownMenu.is(e.target) && dropdownMenu.has(e.target).length === 0
          ...
          dropdownMenu.removeClass('filter--active');
        }
  });
...
// document.querySelectorAll('.catalog__dropdown-toggle').forEach(e => {
//   e.addEventListener('click', e => {
//     const menu = e.currentTarget.dataset.path;
//     document.querySelectorAll('.catalog__category-list').forEach(e => {
